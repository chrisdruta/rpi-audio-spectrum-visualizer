...
class States:
    ...
    def cava(state_machine: StateMachine):
        ...
        def sat_range(i, level, lum=0.25, hue=0, start_sat = 100, end_sat=0):
        ...
        with tempfile.NamedTemporaryFile() as config_file:
            ...
            while state_machine.current_state == States.cava:
                ...
                for i, level in enumerate(sample):
                    #val = get_bar_color(i, level, lum=0.75, start_hue=340, end_hue=20)
                    val = sat_range(i, level, lum=0.4, hue=151, start_sat = 100, end_sat=0)
